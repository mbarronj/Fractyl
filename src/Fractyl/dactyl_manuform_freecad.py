...
class ParametricKeyPlate:
    ...
    def execute(self, obj):
        ...
        """
        keycenter = FreeCAD.Vector( -( kw / 2 ) , -( kh / 2 ) , -( pt / 2 ) )
        platecenter = FreeCAD.Vector( -( pw / 2 ) , -( ph / 2 ) , -( pt / 2 ) )
        cutcenter = FreeCAD.Vector( -( ucw / 2 ) , -( uch / 2 ) , -( pt / 2 ) )
        """
...
myObj = FreeCAD.ActiveDocument.addObject("Part::FeaturePython", "Key_Plate")
